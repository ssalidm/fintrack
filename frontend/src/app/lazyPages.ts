...
export const RecurringTransactionsPage = lazy(
  () =>
    import('@/features/recurring/pages/RecurringTransactionsPage'),
)
...
export const VerifyEmailChangePage = lazy(
  () =>
    import('@/features/auth/pages/VerifyEmailChangePage'),
)
...
export const AdminUserDetailsPage = lazy(
  () =>
    import('@/features/admin/pages/AdminUserDetailsPage'),
)
